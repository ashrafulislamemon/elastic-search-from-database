...
# 2. Index a document containing "Donald Trump"
doc = {
...
# 3. Search for the exact phrase "Donald Trump"
...
if response['hits']['total']['value'] > 0:
    print("Found in the documents!")
else:
    print("No results found for this text.")
...
# multiple keyword search in a text using Elasticsearch
